...
DEPENDEES = obj/Agent.o obj/Graph.o obj/GraphGeneration.o obj/IOjson.o obj/Results.o obj/Simulator.o obj/Utils.o obj/VacStrats.o
...
.PRECIOUS: $(DEPENDEES) bin/trivial bin/cov-sim bin/gen-rg bin/gen-sw bin/matrixC19
